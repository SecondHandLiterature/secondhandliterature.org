      ...
      <section className={board.founders}>
        <div>
          ...
          <p>
            ...
            talented board members to achieve this goal, and I hope you can help
            us too by donating a book! If you couldn&apos;t tell already, I like
            to read in my free time, but I also enjoy playing handball
            (American, not European) and watching movies. The most recent book
            I&apos;ve read is Patron Saints of Nothing, which is about a
            Filipino-American teenager uncovering the truth about his
            cousin&apos;s death (9/10, would recommend!){" "}
          </p>
        </div>
      ...
      <section className={board.members}>
        <div>
          ...
          <p>
            ...
            recently finished reading Interior Chinatown, a teleplay that points
            out the stereotypes in our society as well as what defines
            one&apos;s identity. In my free time, I love to dance, binge watch
            Cdramas, hang out with friends, and try out new things.
          </p>
        </div>
        <div>
          <p>
            ...
            and find not just a home but a community in literature. In my down
            time, I like to read (obviously!), go out with my friends, and cook
            new things. I recently read Lord of the Flies and would definitely
            recommend it if you are looking for a thought-provoking classic.
          </p>
          <div className={board.member}>
        ...
        <div>
          ...
          <p>
            ...
            locations and partner organizations. I am very excited to be a part
            of Second Hand because I believe that our community will benefit
            tremendously from the outpour of books. Personally, I love reading
            fantasy and adventure books, and I&apos;m currently reading the City
            of Fallen Angels, the fourth book in the Mortal Instrument series.
            The book is about a girl who discovers her own heritage and her
            family history in the world of magic.{" "}
          </p>
        </div>
        <div>
          <p>
            ...
            time I enjoy playing music and cubing. My favorite book of all time
            would have to be Prisoner B-3087. It was one of the first books I
            read from cover to cover in one weekend, and it provided a basis for
            my love of history.
          </p>
          <div className={board.member}>
